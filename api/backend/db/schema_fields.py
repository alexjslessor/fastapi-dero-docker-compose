...
# https://github.com/art049/odmantic/blob/master/odmantic/bson.py
class PyObjectId(ObjectId):
    ...
    def __modify_schema__(cls, field_schema):
        ...
        ValueError: Value not declarable with JSON Schema, field: name='id' type=PyObjectId required=False default_factory='<function PyObjectId>' alias='_id'
        '''
